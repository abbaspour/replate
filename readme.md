...
- Donor Application (SPA):
  ...
  - scope: openid profile email offline_access read:donations create:payment_intent
...
- Business Application (SPA with Organizations):
  ...
  - scope: openid profile email offline_access read:organization update:organization read:pickups create:pickups read:schedules update:schedules

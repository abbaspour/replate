...
export interface paths {
    ...
    '/calendar/token': {
        ...
        /**
         * Get federated calendar access token
         * @description Returns a federated access token for the caller to access their calendar provider.
         *     Requires a valid Auth0 access token (audience `business.api`). No additional scopes required.
         */
        get: operations['getCalendarToken'];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        FederatedTokenResponse: {
            access_token: string;
            /** @description Space-delimited list of scopes granted by the upstream provider */
            scope?: string;
            /**
             ...
             */
            expires_in?: number;
            /** @example http://auth0.com/oauth/token-type/federated-connection-access-token */
...
export interface operations {
    ...
    getCalendarToken: {
        ...
        requestBody?: never;
        responses: {
            /** @description Federated calendar access token */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    'application/json': components['schemas']['FederatedTokenResponse'];
                };
            };
            401: components['responses']['Unauthorized'];
            403: components['responses']['Forbidden'];
